...
//{
//    for (int j = i + 1; j < natNums.Length; j++)
//    {
//        if (natNums[i] > natNums[j])
//        {
//            temp = natNums[i];
//            natNums[i] = natNums[j];
//            natNums[j] = temp;
...
//                                                                     3   -  Sorting algorithm in reverse order


//Console.WriteLine("Insert 5 numbers you want them to be shown in reverse order");
...
//Console.WriteLine("Given numbers in reverse order");
//for (int i = 0; i < natNums.Length; i++)
//{
//    for (int j = i + 1; j < natNums.Length; j++)
//    {
